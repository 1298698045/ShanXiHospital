$(function(){
    ...
    '                                            <p class="lis_p" slideIdx="0">停诊信息</p>'+
    '                                            <p class="lis_p" slideIdx="0">就医须知</p>'+
    '                                            <p class="lis_p" slideIdx="0">住院指南</p>'+
    '                                            <p class="lis_p" slideIdx="2">医保指南</p>'+
    '                                            <p class="lis_p" slideIdx="2" tjzx="tjzx">体检中心</p>'+
    '                                        </div>'+
    '                                        <div class="column border hover margin_child">'+
    '                                            <p class="lis_p" slideIdx="2">交通路线</p>'+
    '                                            <p class="lis_p" slideIdx="3">院内导航</p>'+
    '                                            <p class="lis_p" slideIdx="4">查询服务</p>'+
    '                                            <p class="lis_p" slideIdx="5">便民服务</p>'+
    '                                            <p class="lis_p" slideIdx="6">常见问题</p>'+
    '                                        </div>'+
    '                                        <div class="column border column_flex" id="jzxz">'+
    '                                            <h5>就诊须知</h5>'+
    ...
    '                                        </div>'+
    '                                        <div class="column hover margin_child">'+
    '                                            <p class="lis_p" slideIdx="0">医院简介</p>'+
    '                                            <p class="lis_p" slideIdx="0">大事记</p>'+
    '                                            <p class="lis_p" slideIdx="0">医院风貌</p>'+
    '                                            <p class="lis_p" slideIdx="2">医院文化</p>'+
    '                                        </div>'+
    '                                        <div class="column border hover margin_child">'+
    '                                            <p class="lis_p" slideIdx="2">历史沿革</p>'+
    '                                            <p class="lis_p" slideIdx="2">医院领导</p>'+
    '                                            <p class="lis_p" slideIdx="2">视频中心</p>'+
    '                                        </div>'+
    ...
    '                                        </div>'+
    '                                        <div class="column hover margin_child">'+
    '                                            <p class="lis_p" slideIdx="0">通知公告</p>'+
    '                                            <p class="lis_p" slideIdx="0">招标信息</p>'+
    '                                            <p class="lis_p" slideIdx="0">规章制度</p>'+
    '                                            <p class="lis_p" slideIdx="1">院务、党务公开</p>'+
    '                                            <p class="lis_p" slideIdx="3">用药信息</p>'+
    '                                        </div>'+
    '                                        <div class="column border hover margin_child">'+
    '                                            <p class="lis_p" slideIdx="1">医院资源</p>'+
    '                                            <p class="lis_p" slideIdx="3">医保新政</p>'+
    '                                            <p class="lis_p" slideIdx="3">下载专区</p>'+
    '                                        </div>'+
    '                                        <div class="column border column_flex">'+
    '                                            <h5>通知公告</h5>'+
